...
foreach($sites as $site) {
  ...
  $data[$site_name][date('Y-m-d H:i:s')] = array();
  ...
  $data[$site_name][date('Y-m-d H:i:s')]['a_issues'] = $a_issues;
  $data[$site_name][date('Y-m-d H:i:s')]['aa_issues'] = $aa_issues;
  $data[$site_name][date('Y-m-d H:i:s')]['aaa_issues'] = $aaa_issues;
}
